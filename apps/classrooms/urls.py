...
urlpatterns = [
    ...
    path('<int:pk>/subjects/<int:link_pk>/materials/upload/', views.upload_material_view, name='upload_material'),
    path('<int:pk>/subjects/<int:link_pk>/materials/<int:material_id>/delete/', views.delete_material_view, name='delete_material'),
