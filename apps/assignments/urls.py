...
urlpatterns = [
    ...
    path('<int:pk>/quiz/check-duplicates/', views.check_quiz_duplicates_view, name='check_quiz_duplicates'),
    path('<int:pk>/quiz/bulk-delete/', views.bulk_delete_quiz_questions_view, name='bulk_delete_quiz_questions'),
    path('<int:pk>/quiz/sync-points/', views.sync_quiz_points_view, name='sync_quiz_points'),
